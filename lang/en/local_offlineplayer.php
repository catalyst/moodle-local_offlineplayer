...
$string['updatecourse'] = 'Update (Delete existing)';
$string['coursenotavailable'] = 'This course is not available for download';
$string['coursenotvalid'] = 'The download was not valid';
$string['downloadingcourse'] = 'Downloading course';
$string['pleasewait'] = 'Please wait.';
$string['importingcourse'] = 'Importing... (this may take some time)';
...
$string['downloadfailedresume'] = 'Unfortunately the download has been interrupted and {$a} has been downloaded so far, please try again to resume downloading.';
$string['offlineplayernotlinked'] = 'The Offline Player must be linked to the mothership site.';
$string['offlineplayernotmanaginglogin'] = 'The Offline Player has not been configured to allow user-managment. Enabling this will allow data to be deleted anonymously and should not be done on a normal site.';
